 ...
 *
 * @param <T> refer to {@link Parcel#writeValue(Object)} to get a list of all supported
...
public final class CarPropertyConfig<T> implements Parcelable {
     ...
     * AreaIdConfig} which allows properties to specify which enum
    ...
    public static class AreaConfig<T> implements Parcelable {
        ...
        public static final Creator<AreaConfig<Object>> CREATOR =
                getCreator(Object.class);

        private static <E> Creator<AreaConfig<E>> getCreator(final Class<E> clazz) {
    ...
    public static class Builder<T> {
         ...
         * Make sure to call {@link Builder#setAccess(int)} before calling this
         * function.
         *
         * @return Builder<T>
