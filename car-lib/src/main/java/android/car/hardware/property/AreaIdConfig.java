 ...
 *
 * @param <T> matches the type for the {@link CarPropertyConfig}.
 */
public final class AreaIdConfig<T> implements Parcelable {
    @NonNull
    public static final Creator<AreaIdConfig<Object>> CREATOR = getCreator();
    ...
    private static <E> Creator<AreaIdConfig<E>> getCreator() {
    ...
    public static final class Builder<T> {
        ...
        /** Builds a new {@link AreaIdConfig}. */
        @NonNull
