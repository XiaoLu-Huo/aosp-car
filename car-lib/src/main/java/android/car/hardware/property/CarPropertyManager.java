...
public class CarPropertyManager extends CarManagerBase {
    ...
    public interface CarPropertyEventCallback {
         ...
         * case of failure, {@link SetPropertyCallback#onFailure} will be called.
         *
     ...
     * {@link Car} or the main thread if none was provided.
     *
     * <p>
     ...
     * {@link AreaIdConfig#isVariableUpdateRateSupported},
