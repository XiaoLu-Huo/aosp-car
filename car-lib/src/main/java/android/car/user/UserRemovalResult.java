...
public final class UserRemovalResult implements Parcelable, OperationResult {
    ...
    @DataClass.Generated.Member
    /* package-private */ UserRemovalResult(@NonNull android.os.Parcel in) {
    ...
    @DataClass.Generated.Member
    public static final @NonNull Parcelable.Creator<UserRemovalResult> CREATOR
            = new Creator<UserRemovalResult>() {
        @Override
        ...
        @Override
        public UserRemovalResult createFromParcel(@NonNull android.os.Parcel in) {
