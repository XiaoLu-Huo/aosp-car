...
public final class UserStopResponse implements Parcelable, OperationResult {
    ...
    @DataClass.Generated.Member
    /* package-private */ UserStopResponse(@NonNull android.os.Parcel in) {
    ...
    @DataClass.Generated.Member
    public static final @NonNull Parcelable.Creator<UserStopResponse> CREATOR
            = new Creator<UserStopResponse>() {
        @Override
        ...
        @Override
        public UserStopResponse createFromParcel(@NonNull android.os.Parcel in) {
