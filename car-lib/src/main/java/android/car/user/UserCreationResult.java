...
public final class UserCreationResult implements Parcelable, OperationResult {
    ...
    @DataClass.Generated.Member
    /* package-private */ UserCreationResult(@NonNull android.os.Parcel in) {
    ...
    @DataClass.Generated.Member
    public static final @NonNull Parcelable.Creator<UserCreationResult> CREATOR
            = new Creator<UserCreationResult>() {
        @Override
        ...
        @Override
        public UserCreationResult createFromParcel(@NonNull android.os.Parcel in) {
