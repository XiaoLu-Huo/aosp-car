...
public final class UserSwitchResult implements Parcelable, OperationResult {
    ...
    @DataClass.Generated.Member
    /* package-private */ UserSwitchResult(@NonNull android.os.Parcel in) {
    ...
    @DataClass.Generated.Member
    public static final @NonNull Parcelable.Creator<UserSwitchResult> CREATOR
            = new Creator<UserSwitchResult>() {
        @Override
        ...
        @Override
        public UserSwitchResult createFromParcel(@NonNull android.os.Parcel in) {
