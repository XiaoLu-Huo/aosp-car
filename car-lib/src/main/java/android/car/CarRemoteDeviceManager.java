...
public final class CarRemoteDeviceManager extends CarManagerBase {
     ...
     * CarRemoteDeviceManager#FLAG_CLIENT_INSTALLED}. If UI is needed to establish
     * the connection, the caller must wait until {@link
     * CarRemoteDeviceManager#FLAG_OCCUPANT_ZONE_SCREEN_UNLOCKED} and {@link
     * CarRemoteDeviceManager#FLAG_CLIENT_IN_FOREGROUND}) before requesting a
     * connection.
     */
