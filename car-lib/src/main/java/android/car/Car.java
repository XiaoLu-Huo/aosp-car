...
public final class Car implements ICarBase {
    ...
    static {
        ...
        if (!BuildHelper.isUserBuild()) {
            ...
            if (major != -1) {
                ...
                emulated = PlatformVersion.newInstance("EMULATED", major, minor);
    ...
    /**
     * Service name for {@link CarDiagnosticManager}.
     * @hide
     */
    @OptionalFeature
    @SystemApi
    ...
    /**
     * Service name for {@link CarProjectionManager}
     * @hide
     */
    @MandatoryFeature
    @SystemApi
    ...
    /**
     * Service name for {@link OccupantAwarenessManager}
     * @hide
     */
    @OptionalFeature
    @SystemApi
    ...
    /**
     * Service name for {@link CarMediaManager}
     * @hide
     */
    @MandatoryFeature
    @SystemApi
    ...
    /**
     * Service name for {@link CarBugreportManager}
     * @hide
     */
    @MandatoryFeature
    @SystemApi
    ...
    /**
     * Service name for {@link CarStorageMonitoringManager}
     * @hide
     */
    @OptionalFeature
    @SystemApi
    ...
    /**
     * Service name for {@link CarWatchdogManager}
     */
    @MandatoryFeature
    public static final String CAR_WATCHDOG_SERVICE = "car_watchdog";

    /**
     * Service name for {@link CarPerformanceManager}
     *
     * @hide
     */
    @MandatoryFeature
    ...
    /**
     * Service name for {@link CarInputManager}
     * @hide
     */
    @MandatoryFeature
    @SystemApi
    ...
    /**
     * Service name for {@link ClusterHomeManager}
     * @hide
     */
    @OptionalFeature
    ...
    /**
     * Service name for {@link CarEvsManager}
     *
     * @hide
     */
    @OptionalFeature
    ...
    /**
     * Service name for {@link CarTelemetryManager}
     *
     * @hide
     */
    @OptionalFeature
    ...
    /**
     * Service name for {@link CarActivityManager}
     *
     * @hide
     */
    @MandatoryFeature
    ...
    /**
     * Service name for {@link CarRemoteAccessManager}
     *
     * @hide
     */
    @OptionalFeature
    ...
    /**
     * Service name for {@link CarWifiManager}
     *
     * @hide
     */
    @MandatoryFeature
    ...
    public interface CarServiceLifecycleListener {
         ...
         *            {@link #createCar(Context, Handler, long, CarServiceLifecycleListener)}
         *            call.
     ...
     *
     * <p>Starting on {@link Build.VERSION_CODES#TIRAMISU Android 13}, the {@code Car}
     ...
     * {@link Build.VERSION#SDK_INT} for released build but will be
     * {@link Build.VERSION_CODES#CUR_DEVELOPMENT} for platform still under development.
     *
     * @deprecated - use {@code android.os.Build.VERSION#SDK_INT} instead
     */
    @NonNull
