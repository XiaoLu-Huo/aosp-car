...
public final class CarEvsManager extends CarManagerBase {
   ...
   /**
     ...
     *
     * @param status {@link CarEvsStatus}
     */
     ...
     * view and EVS data.
     *
     * @param executor {@link Executor} to execute callbacks.
    ...
    public interface CarEvsStreamCallback {
         ...
         *
         * @param buffer {@link CarEvsBufferDescriptor} contains a EVS frame
         */
        @ExcludeFromCodeCoverageGeneratedReport(reason = BOILERPLATE_CODE)
    ...
    /**
     * Gets the {@link CarEvsBufferDescriptor} from the service listener
     * {@link #CarEvsStreamListenerToService} and dispatches it to an executor provided
     * to the manager.
     *
     * @param buffer {@link CarEvsBufferDescriptor}
     */
    ...
    /**
     * Returns a consumed {@link CarEvsBufferDescriptor}.
     *
     * @param buffer {@link CarEvsBufferDescriptor} to be returned to
     * the EVS service.
     */
     ...
     * @param executor {@link Executor} to run a callback.
     * @return {@link #CarEvsError} to tell the result of the request.
     *         {@link #ERROR_UNAVAILABLE} will be returned if the CarEvsService is not connected to
     *         the native EVS service or the binder transaction fails.
     ...
     *
     * @return {@link CarEvsStatus} that describes current status of
