...
public final class DriverMonitoringDetection implements Parcelable {
    ...
    /** {@link ConfidenceLevel} for the driver monitoring detection. */
    ...
    public static final @NonNull Creator<DriverMonitoringDetection> CREATOR =
            new Creator<DriverMonitoringDetection>() {
