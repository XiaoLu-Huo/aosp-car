...
public final class IoStatsEntry implements Parcelable {
    ...
    public static final Creator<IoStatsEntry> CREATOR =
            new Creator<IoStatsEntry>() {
    ...
    public IoStatsEntry(int uid,
            long runtimeMillis, Metrics foreground, Metrics background) {
        this.uid = uid;
    ...
    public IoStatsEntry(Parcel in) {
        ...
        foreground = in.readParcelable(Metrics.class.getClassLoader());
        background = in.readParcelable(Metrics.class.getClassLoader());
    }

    public IoStatsEntry(UidIoRecord record, long runtimeMillis) {
        uid = record.uid;
        this.runtimeMillis = runtimeMillis;
        foreground = new Metrics(record.foreground_rchar,
                record.foreground_wchar,
                record.foreground_read_bytes,
                record.foreground_write_bytes,
                record.foreground_fsync);
        background = new Metrics(record.background_rchar,
    ...
    public IoStatsEntry(JSONObject in) throws JSONException {
        ...
        foreground = new Metrics(in.getJSONObject("foreground"));
        background = new Metrics(in.getJSONObject("background"));
    }
    ...
    public static final class Metrics implements Parcelable {
        ...
        public static final Creator<Metrics> CREATOR =
                new Creator<Metrics>() {
