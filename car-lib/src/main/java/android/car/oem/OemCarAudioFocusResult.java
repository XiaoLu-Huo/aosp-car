...
public final class OemCarAudioFocusResult implements Parcelable {
     ...
     *
     * @return Map of {@link AudioAttributes} to
     ...
     *
     * @param audioAttributes The {@link AudioAttributes} to get the car audio
     *      fade configuration
     * @return {@link CarAudioFadeConfiguration} if one is available for the
     *     {@link AudioAttributes} or {@code null} if none is assigned
     */
    @FlaggedApi(FLAG_CAR_AUDIO_FADE_MANAGER_CONFIGURATION)
    @Nullable
    ...
    @NonNull
    public static final Creator<OemCarAudioFocusResult> CREATOR =
            new Creator<OemCarAudioFocusResult>() {
        @Override
