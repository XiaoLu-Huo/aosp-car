...
public final class CarAudioManager extends CarManagerBase {
    ...
    /**
     * Extra for {@link AudioAttributes.Builder#addBundle(Bundle)}: when used in an
     * {@link android.media.AudioFocusRequest}, the requester should receive all audio focus events,
     * including {@link AudioManager#AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK}.
     ...
     * @param flags One or more flags (e.g., {@link AudioManager#FLAG_SHOW_UI},
    ...
    public abstract static class CarVolumeCallback {
         ...
         * @param flags see {@link AudioManager} for flag definitions
         */
    ...
    private static final class MediaAudioRequestStatusCallbackWrapper
        ...
        public void onMediaAudioRequestStatusChanged(OccupantZoneInfo info,
                                                     long requestId,
                                                     @MediaAudioRequestStatus int status) throws RemoteException {
            long identity = Binder.clearCallingIdentity();
            try {
                mExecutor.execute(() ->
