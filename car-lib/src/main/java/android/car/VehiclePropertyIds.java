...
public final class VehiclePropertyIds {
     ...
     *
     * <p>Returns the nominal battery capacity in {@link VehicleUnit#WATT_HOUR}, if EV
    ...
    /**
     * List of {@link EvChargingConnectorType}s this vehicle may use.
     *
     ...
     * EV battery level.
     *
     * <p>Returns the current battery level in {@link VehicleUnit#WATT_HOUR}, if EV or
     ...
     *
     * <p>Returns the actual value of battery capacity in {@link VehicleUnit#WATT_HOUR},
     ...
     * {@link VehicleAreaSeat#SEAT_ROW_1_RIGHT}).
     *
     * <p>Property Config:
     * <ul>
     *  <li>{@link android.car.hardware.CarPropertyConfig#VEHICLE_PROPERTY_ACCESS_READ_WRITE} or
     ...
     * VehicleUnit#MILLI_SECS}. A full cycle is defined as a wiper moving from and
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link WindshieldWipersState} are supported.
     *
     * <p>Property Config:
     * <ul>
     *  <li>{@link android.car.hardware.CarPropertyConfig#VEHICLE_PROPERTY_ACCESS_READ}
     ...
     * WindshieldWipersSwitch#AUTO} and {@link
     ...
     * from {@link WindshieldWipersSwitch} are supported.
     *
     * <p>This property is defined as read_write, but OEMs have the option to implement it as read
     * only.
     *
     ...
     * EvChargeState} for possible values for {@code EV_CHARGE_STATE}.
     *
     ...
     * setting in the car. See {@link EvRegenerativeBrakingState} for
     ...
     * in {@link AutomaticEmergencyBrakingState} or {@link
     * ErrorState}. This property should apply for higher speed
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link AutomaticEmergencyBrakingState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * in {@link ForwardCollisionWarningState} or {@link
     * ErrorState}.
     *
     * <p>For the global area ID (0), the {@link
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link ForwardCollisionWarningState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * in {@link BlindSpotWarningState} or {@link
     * ErrorState}.
     *
     * <p>For the global area ID (0), the {@link
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link BlindSpotWarningState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * in {@link LaneDepartureWarningState} or {@link
     * ErrorState}.
     *
     * <p>For the global area ID (0), the {@link
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link LaneDepartureWarningState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * in {@link LaneKeepAssistState} or {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link LaneKeepAssistState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     *
     * <p>When the command {@link LaneCenteringAssistCommand#ACTIVATE}
     * is sent, {@link #LANE_CENTERING_ASSIST_STATE} will be set to {@link
     * LaneCenteringAssistState#ACTIVATION_REQUESTED}. When the
     * command {@link LaneCenteringAssistCommand#ACTIVATE} succeeds,
     * {@link #LANE_CENTERING_ASSIST_STATE} will be set to {@link
     * LaneCenteringAssistState#ACTIVATED}. When the command {@link
     * LaneCenteringAssistCommand#DEACTIVATE} succeeds, {@link
     ...
     * values from {@link LaneCenteringAssistCommand} are supported.
     *
     * <p>Property Config:
     * <ul>
     *  <li>{@link android.car.hardware.CarPropertyConfig#VEHICLE_PROPERTY_ACCESS_WRITE}
     ...
     * in {@link LaneCenteringAssistState} or {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link LaneCenteringAssistState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * defined in the {@link EmergencyLaneKeepAssistState} or {@link
     * ErrorState}. For example, if the feature is not available due
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link EmergencyLaneKeepAssistState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * forms of {@link CruiseControlType}).
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link CruiseControlType} and {@link
     * ErrorState} are supported.
     *
     * Trying to write {@link CruiseControlType#OTHER} or an
     * {@link ErrorState} to this property will throw an {@code
     ...
     * state defined in the {@link CruiseControlState} or {@link
     * ErrorState}. For example, if the feature is not available due
     * to some temporary state, that information should be conveyed through {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link CruiseControlState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     *
     * <p>See {@link CruiseControlCommand} for the details about
     * each supported command.
     *
     * <p>For the global area ID (0), the {@link
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link CruiseControlCommand} are supported.
     *
     ...
     * should return a valid state defined in the {@link
     * HandsOnDetectionDriverState} or {@link
     * ErrorState}. For example, if the feature is not available due
     * to some temporary state, that information should be conveyed through {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link HandsOnDetectionDriverState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * HandsOnDetectionWarning} or {@link
     * ErrorState}. For example, if the feature is not available due
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link HandsOnDetectionWarning} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     *
     * <p>Generally, this property should return a valid state defined in the {@link
     * DriverDrowsinessAttentionState} or {@link
     * ErrorState}. For example, if the feature is not available due
     * to some temporary state, that information should be conveyed through {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link DriverDrowsinessAttentionState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     *
     * <p>Generally, this property should return a valid state defined in the {@link
     * DriverDrowsinessAttentionWarning} or {@link
     * ErrorState}. For example, if the feature is not available due
     * to some temporary state, that information should be conveyed through an {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link DriverDrowsinessAttentionWarning} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
   ...
   /**
     ...
     *
     * <p>Generally, this property should return a valid state defined in the {@link
     * DriverDistractionState} or {@link
     * ErrorState}. For example, if the feature is not available due
     * to some temporary state, that information should be conveyed through {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link DriverDistractionState} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     *
     * <p>Generally, this property should return a valid state defined in the {@link
     * DriverDistractionWarning} or {@link
     * ErrorState}. For example, if the feature is not available due
     * to some temporary state, that information should be conveyed through an {@link
     * ErrorState}.
     *
     ...
     * android.car.hardware.property.AreaIdConfig#getSupportedEnumValues()} array obtained from
     * {@link android.car.hardware.CarPropertyConfig#getAreaIdConfig(int)} specifies which states
     * from {@link DriverDistractionWarning} and {@link
     * ErrorState} are supported.
     *
     * <p>Property Config:
     * <ul>
     ...
     * or {@link ErrorState}. This property is different from the
     ...
     * VehiclePropertyIds#LOW_SPEED_COLLISION_WARNING_ENABLED} and {@link
