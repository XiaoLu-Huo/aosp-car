...
public class CarDiagnosticService extends ICarDiagnostic.Stub
    ...
    private void processDiagnosticData(List<CarDiagnosticEvent> events) {
        ArrayMap<DiagnosticClient, List<CarDiagnosticEvent>> eventsByClient =
                new ArrayMap<>();
        ...
        for (Map.Entry<DiagnosticClient, List<CarDiagnosticEvent>> entry :
                eventsByClient.entrySet()) {
            DiagnosticClient client = entry.getKey();
    ...
    public boolean registerOrUpdateDiagnosticListener(int frameType, int rate,
        ...
        DiagnosticClient diagnosticClient = null;
        ...
        synchronized (mLock) {
            ...
            ClientWithRate<DiagnosticClient> diagnosticClientWithRate = null;
